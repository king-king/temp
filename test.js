    ...
    window.Swiper = function ( e, a ) {
        ...
        function l( e ) {
            ...
            if ( h.params.freeMode ) {
                ...
                (new Date).getTime() - h._lastWheelScrollTime > 60 && (0 > a ? h.slideNext() : h.slidePrev()), h._lastWheelScrollTime = (new Date).getTime();
            }
        ...
        a = a || {};
        for ( var m in u )if ( "undefined" == typeof a[m] ) {
            a[m] = u[m];
        }
        ...
        if ( g = "undefined" == typeof t ? window.Dom7 || window.Zepto || window.jQuery : t, g && (h.$ = g, h.container = g( e ), 0 !== h.container.length) ) {
            ...
            window.navigator.pointerEnabled ? v = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (v = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), h.touchEvents = {
                ...
                if ( h.clickedSlide = t, h.clickedIndex = g( t ).index(), h.params.slideToClickedSlide && void 0 !== h.clickedIndex && h.clickedIndex !== h.activeIndex ) {
                    ...
                    if ( h.params.loop ) {
                        if ( a = g( h.clickedSlide ).attr( "data-swiper-slide-index" ), r > h.slides.length - h.params.slidesPerView ) {
                            h.fixLoop(), r = h.wrapper.children( "." + h.params.slideClass + '[data-swiper-slide-index="' + a + '"]' ).eq( 0 ).index(), setTimeout( function () {
                                h.slideTo( r )
                            }, 0 );
                        }
            ...
            if ( h.onTouchStart = function ( e ) {
                    ...
                    if ( e.originalEvent && (e = e.originalEvent), h.emit( "onTouchEnd", h, e ), w ) {
                        ...
                        if ( h.allowClick && (h.updateClickedSlide( e ), h.emit( "onTap", h, e ), 300 > a && t - P > 300 && (M && clearTimeout( M ), M = setTimeout( function () {
                            ...
                            }, 0 ), !w || !y || !h.swipeDirection || 0 === h.touches.diff || T === S ) {
                            return void(w = y = !1);
                        }
                        w = y = !1;
                        var r;
                    ...
                    if ( "object" == typeof e && e.length ) {
                        ...
                        t = e, h.slides[t] && h.slides.eq( t ).remove(), a > t && a--, a = Math.max( a, 0 );
                    }
                    ...
                    setTranslate : function ( e, t ) {
                        ...
                        if ( h.isArray( s ) ) {
                            ...
                            s instanceof Swiper && t !== s && (e = s.rtl && "horizontal" === s.params.direction ? -h.translate : h.translate, a = (s.maxTranslate() - s.minTranslate()) / (h.maxTranslate() - h.minTranslate()), r = (e - h.minTranslate()) * a + s.minTranslate(), h.params.controlInverse && (r = s.maxTranslate() - r), s.updateProgress( r ), s.setWrapperTranslate( r, !1, h ), s.updateActiveIndex())
                        }
                ...
                if ( void 0 !== document.onmousewheel && (h._wheelEvent = "mousewheel"), !h._wheelEvent ) {
                    try {
            ...
            return h.callPlugins = function ( e ) {
                ...
                }, liveRegion : g( '<span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>' ), notify : function ( e ) {
    ...
    for ( var t = (function () {
        ...
        return e.prototype = {
            addClass : function ( e ) {
                ...
                for ( var a = 0; a < this.length; a++ )if ( 2 === arguments.length ) {
                ...
                var n, o, l = e.split( " " );
                for ( n = 0; n < this.length; n++ )if ( "function" == typeof a || a === !1 ) {
                ...
                for ( var s = e.split( " " ), i = 0; i < s.length; i++ )for ( var n = 0; n < this.length; n++ )if ( "function" == typeof t || t === !1 ) {
                    "function" == typeof t && (a = arguments[1], r = arguments[2] || !1), this[n].removeEventListener( s[i], a, r );
                }
                ...
                for ( var a = t( e ), r = 0; r < this.length; r++ )if ( 1 === a.length ) {
