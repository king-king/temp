...
var KISSY = function ( a ) {
    ...
    var h, k = 0, j = {debug : 10, info : 20, warn : 30, error : 40};
    h = {
        __BUILD_TIME : "20140818163546", Env : {host : this}, Config : {debug : "", fns : {}}, version : '1.47', config : function ( c, g ) {
            var f, b, d = this, i, e = h.Config, o = e.fns;
...
(function ( a, f ) {
    ...
    function k( d, l, b, e, i, g ) {
        ...
        u = a.keys( l );
        x = u.length;
        for ( r = 0; r < x; r++ )if ( q = u[r], q !== c ) {
            var h = d, j = l, w = b, F = e, H = i, K = g;
            if ( w || !(q in h) || H ) {
                var y = h[q], v = j[q];
                if ( y === v ) {
                    y === f && (h[q] = y);
                }
                else if ( F && (v = F.call( j, q, v )), H && v && (a.isArray( v ) || a.isPlainObject( v )) ) {
                    v[c] ? h[q] = v[c] : (j = y && (a.isArray( y ) || a.isPlainObject( y )) ? y : a.isArray( v ) ? [] : {}, h[q] = j, k( j, v, w, F, n, K ));
                }
    ...
    var c = "__MIX_CIRCULAR", g = this, n = !0, b = Object, d = b.create, i = !{toString : 1}.propertyIsEnumerable( "toString" ), e = "constructor,hasOwnProperty,isPrototypeOf,propertyIsEnumerable,toString,toLocaleString,valueOf".split( "," );
    (function ( a, d ) {
        for ( var b in d )a[b] = d[b]
    })( a, {
        stamp : function ( d, b, e ) {
            var e = e || "__~ks_stamped", c = d[e];
            if ( !c && !b ) {
                try {
                    c = d[e] = a.guid( e )
                }
            ...
            var d = a.makeArray( arguments ), b = {}, e, c = d.length;
            for ( e = 0; e < c; e++ )a.mix( b, d[e] );
            return b
        }, augment : function ( d, b ) {
            var e = a.makeArray( arguments ), c = e.length - 2, i = 1, g, r, q = e[c], u = e[c + 1];
            e[1] = b;
            ...
            var d = a.makeArray( arguments ), b = d.length, e = null, c, i, f, r = d[b - 1] === n && b--;
            for ( c = 0; c < b; c++ ) {
                f = ("" + d[c]).split( "." );
                e = r ? g : this;
...
(function ( a, f ) {
    var h = Array.prototype, k = h.indexOf, j = h.lastIndexOf, c = h.filter, g = h.every, n = h.some, b = h.map;
    a.mix( a, {
        each : function ( d, b, e ) {
            if ( d ) {
                var c, l, m = 0;
            ...
            for ( var o = 0, l, m; o < e.length; ) {
                for ( m = e[o]; (l = a.lastIndexOf( m, e )) !== o; )e.splice( l, 1 );
                o += 1
            }
            c && e.reverse();
            return e
            ...
            for ( var o = a && a.length || 0, l = 0; l < o; l++ )if ( l in a && b.call( c, a[l], l, a ) )return !0;
            return !1
        }, makeArray : function ( b ) {
            if ( null == b )return [];
            if ( a.isArray( b ) )return b;
            var c = typeof b.length, e = typeof b;
...
(function ( a, f ) {
    ...
    a.mix( a, {
        urlEncode : function ( a ) {
            ...
            var i = [], g, j, r, q, u, x =
                a.urlEncode;
            for ( g in b )if ( u = b[g], g = x( g ), h( u ) ) {
                i.push( g ), u !== f && i.push( l, x( u + c ) ), i.push( d );
            }
...
(function ( a ) {
    ...
    a.mix( a, {
        noop : function () {
            ...
            var k = k || 0, n = f, b = a.makeArray( g ), d;
            ...
            return {
                id : d, interval : j, cancel : function () {
                    this.interval ?
...
(function ( a, f ) {
    function h( b, d, i ) {
        ...
        if ( "object" === typeof b ) {
            j = b.constructor;
            if ( a.inArray( j, [Boolean, String, Number, Date, RegExp] ) ) {
                e = new j( b.valueOf() );
            }
            else if ( f = a.isArray( b ) ) {
                e = d ? a.filter( b, d ) : b.concat();
            }
            else if ( l = a.isPlainObject( b ) )e = {};
            b[g] = j = a.guid( "c" );
            i[j] = {destination : e, input : b}
        }
        if ( f ) {
            for ( b = 0; b < e.length; b++ )e[b] = h( e[b], d, i );
        }
        else if ( l )for ( m in b )if ( m !== g && (!d || d.call( b, b[m], m, b ) !== c) )e[m] = h( b[m], d, i );
        return e
    }
    ...
    var j = !0, c = !1, g = "__~ks_cloned", n = "__~ks_compared";
    a.mix( a, {
...
(function ( a, f ) {
    var h = /^[\s\xa0]+|[\s\xa0]+$/g, k = String.prototype.trim, j = /\\?\{([^{}]+)\}/g;
    a.mix( a, {
        trim : k ? function ( a ) {
...
(function ( a, f ) {
    var h = {}, k = Object.prototype, j = k.toString;
    a.mix( a, {
        type : function ( a ) {
...
(function ( a ) {
    ...
    var h = /^(\/?)([\s\S]+\/(?!$)|\/)?((?:\.{1,2}$|[\s\S]+?)?(\.[^.\/]*)?)$/, k = a.Path = {
        resolve : function () {
            var j = "", c, g = arguments, h, b = 0;
            ...
            var c =
                "/" === j.charAt( 0 ), g = "/" === j.slice( -1 ), j = f( a.filter( j.split( "/" ), function ( a ) {
                return !!a
            } ), !c ).join( "/" );
            !j && !c && (j = ".");
            j && g && (j += "/");
            ...
            var f = k.normalize( f ), c = k.normalize( c ), g = a.filter( f.split( "/" ), function ( a ) {
                return !!a
            } ), h = [], b, d, i = a.filter( c.split( "/" ), function ( a ) {
                return !!a
            } );
...
(function ( a, f ) {
    ...
    var g = /[#\/\?@]/g, n = /[#\?]/g, b = /[#@]/g, d = /#/g, i = RegExp( "^(?:([\\w\\d+.-]+):)?(?://(?:([^/?#@]*)@)?([\\w\\d\\-\\u0100-\\uffff.+%]*|\\[[^\\]]+\\])(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$" ), e = a.Path, o = {
        scheme : 1,
        userInfo : 2,
        hostname : 3,
        port : 4,
    ...
    k.prototype = {
        constructor : k, clone : function () {
            ...
            var d,
                c;
            if ( "string" === typeof a ) {
                h( this ), d = this._queryMap, c = d[a], c = c === f ? b : [].concat( c ).concat( b ), d[a] = c;
            }
            else {
...
(function ( a, f ) {
    ...
    function c( a ) {
        var b, d = "", c = "", e, i = [6, 9], r, q = n && n.createElement( "div" ), u = [], g = {
            webkit : f, trident : f, gecko : f, presto : f, chrome : f, safari : f, firefox : f, ie : f, ieMode : f, opera : f, mobile : f,
            core : f, shell : f, phantomjs : f, os : f, ipad : f, iphone : f, ipod : f, ios : f, android : f, nodejs : f
        };
        q && q.getElementsByTagName && (q.innerHTML = "<\!--[if IE {{version}}]><s></s><![endif]--\>".replace( "{{version}}", "" ), u = q.getElementsByTagName( "s" ));
        if ( 0 < u.length ) {
            k( a, g );
            e = i[0];
            for ( i = i[1]; e <= i; e++ )if ( q.innerHTML = "<\!--[if IE {{version}}]><s></s><![endif]--\>".replace( "{{version}}", e ), 0 < u.length ) {
                g[c = "ie"] = e;
                break
            }
            ...
            else if ( (e = a.match( /Chrome\/([\d.]*)/ )) && e[1] ) {
                g[c = "chrome"] = h( e[1] );
            }
            ...
            if ( g[d = "presto"] = h( e[1] ), (e = a.match( /Opera\/([\d.]*)/ )) && e[1] ) {
                ...
                if ( (e = a.match( /Opera Mini[^;]*/ )) && e ) {
                    g.mobile = e[0].toLowerCase();
                }
    ...
    var g = a.Env.host, n = g.document, g = g.navigator, b = KISSY.UA =
        c( g && g.userAgent || "" );
...
(function ( a, f ) {
    function h( a ) {
        ...
        if ( !t || a in t ) {
            ...
            w[a] = w[a] || {name : a, prefix : !1}
        }
        return w[a]
    }

    var k = a.Env.host, j = a.UA, c = ["", "Webkit", "Moz", "O", "ms"], g = k.document || {}, n, b, d, i, e, o, l, m = g.documentElement, t, s = !0, p = !1, r = "ontouchstart"in g && !j.phantomjs, q = j.ieMode;
    if ( m && (m.querySelector && 8 !== q && (p = !0), t = m.style, a.each( c, function ( a ) {
            var b = a ? a + "Transition" : "transition",
                c = a ? a + "Transform" : "transform";
            e === f && b in t && (e = a, d = b);
            o === f && c in t && (o = a, i = c)
        } ), s = "classList"in m, j = k.navigator || {}, n = "msPointerEnabled"in j, b = "pointerEnabled"in j, i) ) {
        try {
            var u = g.createElement( "p" );
            m.insertBefore( u, m.firstChild );
            u.style[i] = "translate3d(1px,1px,1px)";
            var x = k.getComputedStyle( u ), E = x.getPropertyValue( i ) || x[i];
            m.removeChild( u );
...
(function ( a ) {
    ...
    function k( b, d ) {
        var c = d.indexOf( "!" );
        if ( -1 !== c ) {
            var e = d.substring( 0, c ), d = d.substring( c + 1 );
            a.use( e, {
                sync : !0, success : function ( a, c ) {
    ...
    var j = a.Loader, c = a.Path, g = a.Env.host, n = a.startsWith, b = j.Status, d = b.ATTACHED, i = b.READY_TO_ATTACH, e = b.LOADED, o =
        b.ATTACHING, l = b.ERROR, m = j.Utils = {}, t = g.document;
    a.mix( m, {
        docHead : function () {
            ...
            var d = h( d ), e = b.Env.mods, f = e[d];
            return f ? f : e[d] = f = new j.Module( a.mix( {name : d, runtime : b}, c ) )
        }, getModules : function ( b, d ) {
            var c = [b], e, f, i, g, h = b.Env.mods;
            a.each( d, function ( d ) {
                e = h[d];
            ...
            for ( var d =
                ...
                g = 1;
                for ( c = d.length - 1; 0 <= c; c-- )if ( (e = j[d[c]]) && "alias"in e ) {
                    g = 0;
                    i = e.alias;
                    "string" === typeof i && (i = [i]);
            ...
            var d = h( d ), i = b.Env.mods, g = i[d];
            g && void 0 !== g.factory || (m.createModuleInfo( b,
                d ), g = i[d], a.mix( g, {name : d, status : e, factory : c} ), a.mix( g, f ))
        }, getHash : function ( a ) {
            var b = 5381, d;
...
(function ( a ) {
    ...
    var j = a.Loader, c = a.Path, g = j.Utils;
    h.prototype = {
    ...
    k.prototype =
    {
        kissy : 1, constructor : k, use : function ( a, d ) {
        ...
        var a, d = this.normalizedRequiresStatus, c = this.status, e = this.requires;
...
(function ( a ) {
    ...
    var k = 30, j = a.UA, c = a.Loader.Utils, g = 0, n = {};
...
(function ( a ) {
    var f = a.Env.host.document, h = a.Loader.Utils, k = a.Path, j = {}, c, g = a.UA;
    a.getScript = function ( n, b, d ) {
        ...
        var r = function ( b ) {
            ...
            delete j[n]
        }, b = "onload"in p, d = a.Config.forceCssPoll || g.webkit && 536 > g.webkit;
        o && d && b && (b = !1);
...
(function ( a, f ) {
    ...
    var k = a.Loader, j = k.Utils, c = a.Env.host.location, g, n, b = a.Config.fns;
...
(function ( a, f ) {
    function h( b, c, e, i, h ) {
        ...
        a.each( c, function ( c ) {
            ...
            c.combine || (q = c.mods[0], "css" === q.getType() ? q = f : g && (p = q.name, a.now(), m.attrs = {"data-mod-name" : q.name}));
    ...
    var g = 10 > a.UA.ieMode, n = a.Loader, b = n.Status, d = n.Utils, i = d.getHash, e = b.LOADING, o = b.LOADED, l = b.READY_TO_ATTACH, m = b.ERROR, t = a.now();
    k.groupTag = t;
    var s, p;
    k.add = function ( b, c, e, i, h ) {
        if ( 3 === h && a.isArray( c ) )var k = c, c = e, e = {requires : k, cjs : 1};
        if ( "function" === typeof b ||
            1 === h ) {
            if ( e = c, c = b, e = j( e, c ), g ) {
                for ( var b = a.Env.host.document.getElementsByTagName( "script" ), l, h = b.length - 1; 0 <= h; h-- )if ( k = b[h], "interactive" === k.readyState ) {
                    l = k;
                    break
                }
                ...
                s = {factory : c, config : e};
            }
        }
        else {
            g ? p = null : s = f, e = j( e, c ), d.registerModule( i, b, c, e )
        }
    };
    a.augment( k, {
        use : function ( b ) {
            var c = a.Config.timeout, e = this.runtime, b = a.keys( this.calculate( b ) );
            ...
            var f, g, i, h, j = this.waitingModules, k = this.runtime, c = c || {}, b = b || {};
            ...
            var b = this.runtime.Config, c = b.comboPrefix, d = b.comboSep, e = b.comboMaxFileNum, b = b.comboMaxUrlLength, f = {}, a = this.getComboMods( a, f ), g = {}, h;
            for ( h in a ) {
                g[h] = {};
                for ( var j in a[h] ) {
                    var k = [], l = [], m = a[h][j], n = m.tags,
                        p = (n = 1 < n.length ? i( n.join( "" ) ) : n[0]) ? "?t=" + encodeURIComponent( n ) + "." + h : "", n = p.length, o = f[j].toString(), s = o.length, t = o + c, A = g[h][j] = [], o = t.length;
                    A.charset = m.charset;
                    A.mods = [];
                    for ( var J = function () {
                        A.push( {combine : 1, fullpath : t + k.join( d ) + p, mods : l} )
                    }, C = 0; C < m.length; C++ ) {
                        var B = m[C];
                        A.mods.push( B );
                        var D = B.getFullPath();
                        if ( B.canBeCombined ) {
                            ...
                            A.push( {combine : 0, fullpath : D, mods : [B]} )
                        }
                    }
                    k.length &&
                    J()
...
(function ( a, f ) {
    ...
    var k = a.Loader, j = a.Env, c = k.Utils, g = a.setImmediate, n = k.ComboLoader;
    h.prototype = {
    ...
    a.mix( a, {
        add : function ( b, c, f ) {
            ...
            if ( b ) {
                var f = c.unalias( a, c.normalizeModNamesWithAlias( a,
                    [b], d ) );
...
(function ( a ) {
    function f( f ) {
        ...
        var f = (f = f.getAttribute( "data-config" )) ? (new Function( "return " + f ))() : {}, h = f.comboPrefix || g, k = f.comboSep || n, m, t = e.indexOf( h );
        -1 === t ? m = e.replace( b, "$1" ) : (m = e.substring( 0, t ), "/" !== m.charAt( m.length - 1 ) && (m += "/"), h = e.substring( t + h.length ).split( k ), a.each( h, function ( a ) {
    ...
    function h() {
        var a =
            k.getElementsByTagName( "script" ), b, c;
        for ( b = a.length - 1; 0 <= b; b-- )if ( c = f( a[b] ) )return c;
        return null
    }

    var k = a.Env.host && a.Env.host.document, j = a.Loader.Utils, c = "20140818163546", g = "??", n = ",", b = /^(.*)(seed|kissy)(?:-min)?\.js[^/]*/i, d = /(seed|kissy)(?:-min)?\.js/i;
    a.config( {comboPrefix : g, comboSep : n, charset : "utf-8", lang : "zh-cn"} );
    a.UA.nodejs ? a.config( {
        charset : "utf-8",
        base : __dirname.replace( /\\/g, "/" ).replace( /\/$/, "" ) + "/"
    } ) : k && k.getElementsByTagName && a.config( a.mix( {comboMaxUrlLength : 2E3, comboMaxFileNum : 40}, h() ) )
})( KISSY );
KISSY.add( "i18n", {
    alias : function ( a, f ) {
...
(function ( a, f ) {
    ...
    var k = a.Env.host, j = a.UA, c = k.document, g = c && c.documentElement, n = k.location, b = 0, d = [], i = /^#?([\w-]+)$/, e = /\S/, o = !(!c || !c.addEventListener), l = "load", m = o ? function ( a, b, c ) {
    ...
    a.mix( a, {
        isWindow : function ( a ) {
            ...
            var b =
                (b + "").match( i )[1], e = 1, f = a.later( function () {
                if ( 500 < ++e ) {
                    f.cancel();
                }
                else {
...
(function ( a ) {
    ...
    var f = a.UA, h = a.Env.host, k = (f.nodejs && "object" === typeof global ? global : h).JSON;
    9 > f.ieMode && (k = null);
    if ( k ) {
        a.add( "json", function () {
            return a.JSON = k
        ...
        var j = /^[\],:{}\s]*$/, c = /(?:^|:|,)(?:\s*\[)+/g, g = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, n = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g;
