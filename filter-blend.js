...
(function () {
    function blend(imgData1, imgData2, model) {
        ...
        switch (model) {
            ...
            case "average"://平均混合
                loopArray(imgData1.data, 4, function (i) {
                    imgData.data[i] = (imgData1.data[i] + imgData2.data[i]) / 2 << 0;
                    imgData.data[i + 1] = (imgData1.data[i + 1] + imgData2.data[i + 1]) / 2 << 0;
                    imgData.data[i + 2] = (imgData1.data[i + 2] + imgData2.data[i + 2]) / 2 << 0;
                    imgData.data[i + 3] = 255;
                });
                break;
            case "multiply"://正片叠底
                loopArray(imgData1.data, 4, function (i) {
                    imgData.data[i] = imgData1.data[i] * imgData2.data[i] / 255 << 0;
                    imgData.data[i + 1] = imgData1.data[i + 1] * imgData2.data[i + 1] / 255 << 0;
                    imgData.data[i + 2] = imgData1.data[i + 2] * imgData2.data[i + 2] / 255 << 0;
                    imgData.data[i + 3] = imgData1.data[i + 3] * imgData2.data[i + 3] / 255 << 0;
                });
                break;
            default:
                //Color-Dodqe 滤色
