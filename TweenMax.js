...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push( function () {
    _gsScope._gsDefine( "TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function ( t, e, i ) {
        ...
        }, n = 1e-10, a = i._internals, o = a.isSelector, h = a.isArray, l = r.prototype = i.to( {}, 0.1, {} ), _ = [];
        ...
        return _.constructor = s, _.kill()._gc = !1, s.version = "1.13.2", _.invalidate = function () {
            ...
            return o.time = this._parseTimeOrLabel( t ), s = Math.abs( Number( o.time ) - this._time ) / this._timeScale || 0.001, a = new e( this, s, o ), o.onStart = function () {
        ...
        var l, _, u, p, c, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, d = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, g = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /[^\d\-\.]/g, y = /(?:\d|\-|\+|=|#|\.)*/g, T = /opacity *= *([^)]*)/i, w = /opacity:([^;]*)/i, x = /alpha\(opacity *=.+?\)/i, b = /^(rgb|hsl)/, P = /([A-Z])/g, S = /-([a-z])/gi, k = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, R = function ( t, e ) {
            ...
            for ( t = t.charAt( 0 ).toUpperCase() + t.substr( 1 ), i = ["O", "Moz", "ms", "Ms", "Webkit"], s = 5;
                --s > -1 && void 0 === r[i[s] + t]; ) {
            }
        ...
        var le = function ( t, e, i, s ) {
            ...
            for ( var e, i, s, r, n = this.data, a = n.proxy, o = n.firstMPT, h = 0.000001; o; ) {
        ...
        var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split( "," ), ye = V( "transform" ), Te = B + "transform", we = V( "transformOrigin" ), xe = null !== V( "perspective" ), be = N.Transform = function () {
            ...
            var r, n, o, h, l, _, u, p, c, f, m, d, g, v = i ? t._gsTransform || new be : new be, y = 0 > v.scaleX, T = 0.00002, w = 100000, x = 179.99, b = x * M, P = xe ? parseFloat( W( t, we, e, !1, "0 0 0" ).split( " " )[2] ) || v.zOrigin || 0 : 0, S = parseFloat( a.defaultTransformPerspective ) || 0;
            ...
            var e, i, s = this.data, r = -s.rotation * M, n = r + s.skewX * M, a = 100000, o = (0 | Math.cos( r ) * s.scaleX * a) / a, h = (0 | Math.sin( r ) * s.scaleX * a) / a, l = (0 | Math.sin( n ) * -s.scaleY * a) / a, _ = (0 | Math.cos( n ) * s.scaleY * a) / a, u = this.t.style, p = this.t.currentStyle;
            if ( p ) {
            ...
            if ( p ) {
                var L = 0.0001;
                L > A && A > -L && (A = O = 0.00002), L > C && C > -L && (C = O = 0.00002), !E || S.z || S.rotationX || S.rotationY || (E = 0)
            }
            if ( R || S.skewX ) {
            ...
            u = 1, s = r = o = h = l = _ = c = f = m = 0, d = E ? -1 / E : 0, g = S.zOrigin, v = 100000, R = S.rotationY * M, R && (y = Math.cos( R ), T = Math.sin( R ), l = u * -T, f = d * -T, s = e * T, o = n * T, u *= y, d *= y, e *= y, n *= y), R = S.rotationX * M, R && (y = Math.cos( R ), T = Math.sin( R ), w = i * y + s * T, x = a * y + o * T, b = _ * y + u * T, P = m * y + d * T, s = i * -T + s * y, o = a * -T + o * y, u = _ * -T + u * y, d = m * -T + d * y, i = w, a = x, _ = b, m = P), 1 !== O && (s *= O, o *= O, u *= O, d *= O), 1 !== C && (i *= C, a *= C, _ *= C, m *= C), 1 !== A && (e *= A, n *= A, l *= A, f *= A), g && (c -= g, r = s * c, h = o * c, c = u * c + g), r = (w = (r += D) - (r |= 0)) ? (0 | w * v + (0 > w ? -0.5 : 0.5)) / v + r : r, h = (w = (h += z) - (h |= 0)) ? (0 | w * v + (0 > w ? -0.5 : 0.5)) / v + h : h, c = (w = (c += I) - (c |= 0)) ? (0 | w * v + (0 > w ? -0.5 : 0.5)) / v + c : c, k[ye] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix3d(" : "matrix3d(") + [(0 | e * v) / v, (0 | n * v) / v, (0 | l * v) / v, (0 | f * v) / v, (0 | i * v) / v, (0 | a * v) / v, (0 | _ * v) / v, (0 | m * v) / v, (0 | s * v) / v, (0 | o * v) / v, (0 | u * v) / v, (0 | d * v) / v, r, h, c, E ? 1 + -c / E : 1].join( "," ) + ")"
        ...
        de( "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser : function ( t, e, i, s, n, o, h ) {
                ...
                var l, _, u, p, c, f, m, d = s._transform = Pe( t, r, !0, h.parseTransform ), g = t.style, v = 0.000001, y = ve.length, T = h, w = {};
        ...
        h = a.prototype, h._firstPT = null, h._onInitTween = function ( t, e, o ) {
            ...
            var e, i, s, r = this._firstPT, n = 0.000001;
        ...
        propName : "directionalRotation", version : "0.2.1", API : 2, init : function ( t, e ) {
            ...
            var i, s, r, n, a, o, h = e.useRadians === !0 ? 2 * Math.PI : 360, l = 0.000001;
            for ( i in e ) {
        ...
        return d.constructor = m, d.getRatio = function ( t ) {
            ...
            e = e || {};
            for ( var i, s, r, n, a, o, h = e.taper || "none", l = [], _ = 0, u = 0 | (e.points || 20), c = u, f = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = "number" == typeof e.strength ? 0.4 * e.strength : 0.4; --c > -1; ) {
                i = f ? Math.random() : 1 / u * c, s = d ? d.getRatio( i ) : i, "none" === h ? r = g : "out" === h ? (n = 1 - i, r = n * n * g) : "in" === h ? r = i * i * g : 0.5 > i ? (n = 2 * i, r = 0.5 * n * n * g) : (n = 2 * (1 - i), r = 0.5 * n * n * g), f ? s += Math.random() * r - 0.5 * r : c % 2 ? s += 0.5 * r : s -= 0.5 * r, m && (s > 1 ? s = 1 : 0 > s && (s = 0)), l[_++] = {
                    x : i,
                    y : s
                }
            }
    ...
    if ( !i.TweenLite ) {
        ...
        g( "Ticker", function ( t, e ) {
            var i, s, r, n, h, l = this, u = k(), c = e !== !1 && P, f = 500, m = 33, d = function ( t ) {
                var e, a, o = k() - R;
                o > f && (u += o - m), R += o, l.time = (R - u) / 1000, e = l.time - h, (!i || e > 0 || t === !0) && (l.frame++, h += e + (e >= n ? 0.004 : n - e), a = !0), t !== !0 && (r = s( d )), a && l.dispatchEvent( "tick" )
            };
        ...
        var C = function () {
            o && k() - R > 2000 && a.wake(), setTimeout( C, 2000 )
        };
        ...
        var I = [], E = {}, L = D._internals = {
            ...
            var t = I.length;
            for ( E = {}; --t > -1; ) {
                s = I[t], s && s._lazy !== !1 && (s.render( s._lazy[0], s._lazy[1], !0 ), s._lazy = !1)
            }
            I.length = 0
        };
            ...
            if ( t >= h ) {
                ...
                if ( 1e-7 > t ) {
                    ...
                    if ( this._totalTime = this._time = t, this._easeType ) {
                        ...
                        (1 === p || 3 === p && u >= 0.5) && (u = 1 - u), 3 === p && (u *= 2), 1 === c ? u *= u : 2 === c ? u *= u * u : 3 === c ? u *= u * u * u : 4 === c && (u *= u * u * u * u), this.ratio = 1 === p ? 1 - u : 2 === p ? u : 0.5 > t / h ? u / 2 : 1 - u / 2
                    }
                    else {
