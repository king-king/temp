    ...
    a.define( '/gif.coffee' , function ( b , k , j , i ) {
        ...
        d = a( 'events' , b ).EventEmitter, e = a( '/browser.coffee' , b ), f = function ( f , b , d ) {
            ...
            return h( a , f ), b = {
                ...
                width : null ,
                height : null
            }, d = { delay : 500 , copy : !1 }, a.prototype.setOption = function ( a , b ) {
                ...
                if ( 'undefined' !== typeof CanvasRenderingContext2D && null != CanvasRenderingContext2D && b instanceof CanvasRenderingContext2D || 'undefined' !== typeof WebGLRenderingContext && null != WebGLRenderingContext && b instanceof WebGLRenderingContext )c.copy ? a.data = this.getContextData( b ) : a.context = b; else if ( null != b.childNodes )null != this.options.width || this.setOption( 'width' , b.width ), null != this.options.height || this.setOption( 'height' , b.height ), c.copy ? a.data = this.getImageData( b ) : a.image = b; else throw new Error( 'Invalid image' );
        ...
        var a = e.EventEmitter = b.EventEmitter , c = typeof Array.isArray === 'function' ? Array.isArray : function ( a ) {
